                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="uploads/work/preview/<?=$after_assoc['preview'] ?>" alt="img">
                                </div>
                                    ...
                                    <div class="blog-list-meta">
                                        <ul>
                                            ...
                                            <li class="blog-post-share">
                                                <a href="https://www.facebook.com/sharer/sharer.php?u=portfolio-single.php?id=<?=$id?>"><i class="fab fa-facebook-f"></i></a>
                                                <a href="//twitter.com/sharer/sharer.php>?u=portfolio-single.php?id=<?=$id?>"><i class="fab fa-twitter"></i></a>
