                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="index.html"><img src="/kufa/dashboard_asset/images/logo-full.png" alt=""></a>
									</div>
                                    ...
                                    <form action="login_post.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if(isset( $_SESSION['wrong_password'])){ ?>
                                                    <div class="alert alert-danger"><?= $_SESSION['wrong_password'] ?></div>
                                    ...
                                    <div class="new-account mt-3">
                                        <p class="text-white">Don't have an account? <a class="text-white" href="/kufa/register.php">Sign up</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
