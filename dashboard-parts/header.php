...
$select_user = mysqli_query($db_connection, $select);
$after_assoc = mysqli_fetch_assoc($select_user);

$unseen_message = "SELECT * FROM messages WHERE status=0";
$message_result = mysqli_query($db_connection, $unseen_message);


$message_count = "SELECT COUNT(*) as total FROM messages WHERE status=0";
$message_res = mysqli_query($db_connection, $message_count);
$after_assoc_count = mysqli_fetch_assoc($message_res);
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/kufa/dashboard_asset/images/favicon.png">
	<link rel="stylesheet" href="/kufa/dashboard_asset/vendor/chartist/css/chartist.min.css">
    <link href="/kufa/dashboard_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/kufa/dashboard_asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="/kufa/dashboard_asset/images/logo.png" alt="">
                <img class="logo-compact" src="/kufa/dashboard_asset/images/logo-text.png" alt="">
                <img class="brand-title" src="/kufa/dashboard_asset/images/logo-text.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
								...
								<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<div class="pulse-css"><span><?=$after_assoc_count['total']  ?></span></div>
                                </a>
                                    ...
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
											<?php 
												...
												foreach($message_result as $messag) {
												 ?>
													<li>
													<a href="message_view.php?id=<?=$messag['id'] ?>">
														<div class="timeline-panel">
															<div class="media mr-2">
																<img alt="image" width="50" src="images/avatar/1.jpg">
															</div>
															<div class="media-body">
																<h6 class="mb-1"><?=$messag['name']?> end you Photo</h6>
																<small class="d-block"><?=date($messag['date'] ) ?></small>
															</div>
														</div>
													</a>
												</li>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									<?php if($after_assoc['photo'] == null) {?>
										<img src="../dashboard_asset/images/profile/default.png" width="20" alt="">
										
										<?php } else{?>

											<img src="../uploads/users/<?=$after_assoc['photo']  ?>" width="20" alt=""/>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/kufa/users/profile.php" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ml-2">Profile </span>
                                    </a>
                                    <a href="/kufa/logout.php" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="/kufa/dashboard.php" aria-expanded="false">Dashboard</a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/kufa/users/users.php">all user</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/kufa/logo/logo.php">all user</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Banner Details</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/kufa/banner/banner.php">banner-info</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Skill Part</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/kufa/skill/skill.php">Skill Information</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Icon Part</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/kufa/icon/social.php">Icon Status</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Work Part</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/kufa/works/work.php">Work Information</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/kufa/message/message.php">message Information</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/kufa/menu/menu.php">Add Menu</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/kufa/counter/counter.php">Counter part</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Service Part</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/kufa/service/service.php">service Info</a></li>
                        </ul>
                    </li>
                </ul>
			</div>
